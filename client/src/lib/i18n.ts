...
const enTranslations = {
  ...
  admin: {
    ...
    andMoreSessions: 'and {{count}} more sessions',
    dashboard: 'Dashboard',
    settings: 'Settings',
    users: 'Users',
    logs: 'Logs',
    ...
    managePlanFeatures: 'Manage features available for each subscription plan',
    basic: 'Basic',
    intermediate: 'Intermediate',
    loadingFeatures: 'Loading features...',
    noDescription: 'No description provided',
    noBasicPlanFeatures: 'No features added for the Basic plan yet',
    noIntermediatePlanFeatures: 'No features added for the Intermediate plan yet',
    ...
    enableFeatureImmediately: 'Enable immediately',
    adding: 'Adding...',
    ...
    testKnowledgeDescription: 'Test how well the AI has learned your documents',
    testPrompt: 'Enter a question about your documents',
    testingKnowledge: 'Testing knowledge...',
    askAIAboutDocument: 'Ask AI about document',
    testResultTitle: 'Test Result',
    contentUsage: 'Document Content Usage',
    contentUsageScore: 'Score',
    contentSources: 'Content Sources',
    contentPreview: 'Response Preview',
    noResults: 'No results yet',
    sendQuestion: 'Send Question',
    documentSelect: 'Select Document',
    testDocumentFirst: 'Please select a document first',
    testingPending: 'Ask a question to test document knowledge',
    noDocument: 'No document',
    documentDetails: 'Document Details',
    
    // Interaction Training
    interactionTraining: 'User Interaction Training',
    interactionTrainingDescription: 'Generate training documents from user interactions to improve AI responses',
    interactionsProcessed: 'Interactions Processed',
    processedCountMessage: '{{count}} interactions successfully converted to training documents',
    ...
    recentSessionsList: 'Recent Sessions',
    ...
    days: 'days',
    timeRangeDescription: 'Processes sessions from the selected number of days ago until today',
    maxSessions: 'Maximum Sessions',
    maxSessionsDescription: 'Limit the number of sessions to process (oldest first)',
    autoCategories: 'Auto-categorize',
    autoCategoriesDescription: 'Automatically create and assign a category for generated training documents',
    refreshSessions: 'Refresh Sessions',
    processInteractions: 'Process Interactions',
    ...
    widgetManagementDesc: 'Create and manage widgets to embed in external websites',
    noWidgetsFound: 'No widgets found',
    noWidgetsDesc: 'No widgets created yet. Click the "New Widget" button to create one.',
    newWidget: 'New Widget',
    editWidget: 'Edit Widget',
    deleteWidget: 'Delete Widget',
    widgetName: 'Widget Name',
    widgetApiKey: 'API Key',
    widgetAvatar: 'Chat Avatar',
    widgetAvatarUrl: 'Avatar image URL',
    widgetWelcomeMessage: 'Welcome Message',
    widgetGreeting: 'Welcome Message',
    widgetThemeColor: 'Theme Color',
    widgetPosition: 'Widget Position',
    widgetDomains: 'Allowed Domains',
    widgetDomainsDesc: 'List of domains where this widget can be embedded (optional)',
    addDomain: 'Add Domain',
    domainName: 'Domain Name',
    enterDomainName: 'Enter domain name',
    widgetPreview: 'Widget Preview',
    widgetEmbedCode: 'Embed Code',
    copyEmbedCode: 'Copy Code',
    embedCodeCopied: 'Code copied to clipboard',
    ...
    confirmDeleteWidget: 'Are you sure you want to delete this widget? This action cannot be undone.',
    widgetSettings: 'Widget Settings',
    generateApiKey: 'Generate API Key',
    regenerateApiKey: 'Regenerate API Key',
    confirmRegenerateApiKey: 'Are you sure you want to regenerate the API key? The old key will be invalidated.',
    bottomRight: 'Bottom right',
    bottomLeft: 'Bottom left',
    topRight: 'Top right',
    topLeft: 'Top left',
    uploadImage: 'Upload Image',
    imageMaxSize: 'Maximum size: 5MB',
    previewChat: 'Preview Chat',
    widgetInitialOpen: 'Open automatically',
    widgetDimensions: 'Widget dimensions',
    widgetWidth: 'Width',
    widgetHeight: 'Height'
  },
  errors: {
...
const ptTranslations = {
  ...
  admin: {
    ...
    andMoreSessions: 'e mais {{count}} sessões',
    ...
    // Training Test
    testKnowledge: 'Testar Conhecimento',
    testKnowledgeDescription: 'Teste o quanto a IA aprendeu com seus documentos',
    testPrompt: 'Digite uma pergunta sobre seus documentos',
    testingKnowledge: 'Testando conhecimento...',
    askAIAboutDocument: 'Pergunte à IA sobre o documento',
    testResultTitle: 'Resultado do Teste',
    contentUsage: 'Uso do Conteúdo do Documento',
    contentUsageScore: 'Pontuação',
    contentSources: 'Fontes de Conteúdo',
    contentPreview: 'Prévia da Resposta',
    noResults: 'Nenhum resultado ainda',
    sendQuestion: 'Enviar Pergunta',
    documentSelect: 'Selecionar Documento',
    testDocumentFirst: 'Por favor, selecione um documento primeiro',
    testingPending: 'Faça uma pergunta para testar o conhecimento do documento',
    noDocument: 'Nenhum documento',
    documentDetails: 'Detalhes do Documento',
    
    // Interaction Training
    interactionTraining: 'Treinamento por Interações',
    interactionTrainingDescription: 'Gere documentos de treinamento a partir de interações de usuários para melhorar as respostas da IA',
    interactionsProcessed: 'Interações Processadas',
    processedCountMessage: '{{count}} interações convertidas com sucesso em documentos de treinamento',
    processingError: 'Erro de Processamento',
    noRecentSessions: 'Nenhuma sessão recente encontrada',
    totalSessions: 'Total de Sessões',
    periodCovered: 'Período Coberto',
    today: 'Hoje',
    toBeProcessed: 'A Serem Processadas',
    recentSessionsList: 'Sessões Recentes',
    sessionId: 'ID da Sessão',
    startDate: 'Data de Início',
    processingOptions: 'Opções de Processamento',
    timeRange: 'Intervalo de Tempo',
    days: 'dias',
    timeRangeDescription: 'Processa sessões desde o número selecionado de dias atrás até hoje',
    maxSessions: 'Máximo de Sessões',
    maxSessionsDescription: 'Limita o número de sessões a processar (mais antigas primeiro)',
    autoCategories: 'Auto-categorizar',
    autoCategoriesDescription: 'Cria e atribui automaticamente uma categoria para os documentos de treinamento gerados',
    refreshSessions: 'Atualizar Sessões',
    processInteractions: 'Processar Interações',
    ...
    widgetManagement: 'Gerenciamento de Widgets',
    widgetManagementDesc: 'Crie e gerencie widgets para incorporar em sites externos',
    noWidgetsFound: 'Nenhum widget encontrado',
    noWidgetsDesc: 'Não há widgets criados ainda. Clique no botão "Novo Widget" para criar um.',
    newWidget: 'Novo Widget',
    editWidget: 'Editar Widget',
    deleteWidget: 'Excluir Widget',
    widgetName: 'Nome do Widget',
    widgetApiKey: 'Chave de API',
    widgetAvatar: 'Avatar do Chat',
    widgetAvatarUrl: 'URL da imagem do avatar',
    widgetWelcomeMessage: 'Mensagem de boas-vindas',
    widgetGreeting: 'Mensagem de boas-vindas',
    widgetThemeColor: 'Cor do tema',
    widgetPosition: 'Posição do widget',
    widgetDomains: 'Domínios permitidos',
    widgetDomainsDesc: 'Lista de domínios onde este widget pode ser incorporado (opcional)',
    ...
    widgetEmbedCode: 'Código de Incorporação',
    copyEmbedCode: 'Copiar Código',
    embedCodeCopied: 'Código copiado para a área de transferência',
    widgetCreated: 'Widget criado com sucesso',
    widgetUpdated: 'Widget atualizado com sucesso',
    widgetDeleted: 'Widget excluído com sucesso',
    confirmDeleteWidget: 'Tem certeza que deseja excluir este widget? Esta ação não pode ser desfeita.',
    widgetSettings: 'Configurações do Widget',
    generateApiKey: 'Gerar Chave de API',
    regenerateApiKey: 'Regenerar Chave de API',
    confirmRegenerateApiKey: 'Tem certeza que deseja regenerar a chave de API? A chave antiga será invalidada.',
    bottomRight: 'Inferior direito',
    bottomLeft: 'Inferior esquerdo',
    topRight: 'Superior direito',
    topLeft: 'Superior esquerdo',
    uploadImage: 'Carregar Imagem',
    imageMaxSize: 'Tamanho máximo: 5MB',
    previewChat: 'Visualizar Chat',
    widgetInitialOpen: 'Abrir automaticamente',
    widgetDimensions: 'Dimensões do widget',
    widgetWidth: 'Largura',
    widgetHeight: 'Altura'
  },
  errors: {
